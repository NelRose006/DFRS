...
$sql = "SELECT * FROM crops WHERE user_id = $userId";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO crops (user_id, name, type, amount, date, description) 
...
<body>
    ...
    <div class="container">
        ...
        <button onclick="document.getElementById('addItemModal').style.display='block'">Add Crop</button><br><br>

        <input type="text" id="searchInput" onkeyup="searchItems()" placeholder="Search Crops...">
